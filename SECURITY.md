...
1. Open a [GitHub private vulnerability report](https://github.com/jonfitt/fibonacci-sphere/security/advisories/new) on this repository, **or**
2. Contact the maintainer through GitHub (@jonfitt) with details if private advisories are unavailable.
